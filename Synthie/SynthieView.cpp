...
BEGIN_MESSAGE_MAP(CSynthieView, CWnd)
	...
	ON_COMMAND(ID_GENERATE_RECORDEDPERFORMANCESYNTHESIZER, &CSynthieView::OnGenerateRecordedperformancesynthesizer)
END_MESSAGE_MAP()
...
void CSynthieView::OnGenerateRecordedperformancesynthesizer()
{
	// Call to open the generator output
	if (!GenerateBegin())
		return;
